# Generated by Django 3.2.16 on 2024-04-18 05:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='amount_trigger',
            field=models.CharField(choices=[(None, '-------'), ('Less than and equals to', 'Less than and equals to'), ('Equals to', 'Equals to'), ('Less than', 'Less than'), ('More than', 'More than'), ('More than and equals to', 'More than and equals to')], max_length=128, null=True),
        ),
        migrations.AlterField(
            model_name='discountvoucher',
        ...
        migrations.AlterField(
            model_name='supplier',
            name='prefix',
            field=models.CharField(choices=[('+52', '+52 (Mexico)'), ('+1', '+1 (Canada)'), ('+20', '+20 (Egypt)'), ('+82', '+82 (South Korea)'), ('+86', '+86 (China)'), ('+39', '+39 (Italy)'), ('+966', '+966 (Saudi Arabia)'), ('+44', '+44 (UK)'), ('+65', '+65 (Singapore)'), ('+1', '+1 (US)'), ('+7', '+7 (Russia)'), ('+81', '+81 (Japan)'), ('+34', '+34 (Spain)'), ('+33', '+33 (France)'), ('+55', '+55 (Brazil)'), ('+91', '+91 (India)'), ('+61', '+61 (Australia)'), ('+49', '+49 (Germany)'), ('+64', '+64 (New Zealand)'), ('+971', '+971 (UAE)')], max_length=250),
        ),
        migrations.AlterField(
            model_name='voucher',
            name='discount_type',
